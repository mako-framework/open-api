	...
	public function swagger(URLBuilder $uRLBuilder): string
	{
		...
		<html>
			<head>
				...
				<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/swagger-ui/5.18.3/swagger-ui.min.css">
			</head>
			<body>
				<div id="swagger-ui"></div>
				<script src="https://cdnjs.cloudflare.com/ajax/libs/swagger-ui/5.18.3/swagger-ui-bundle.min.js"></script>
				<script src="https://cdnjs.cloudflare.com/ajax/libs/swagger-ui/5.18.3/swagger-ui-standalone-preset.min.js"></script>
